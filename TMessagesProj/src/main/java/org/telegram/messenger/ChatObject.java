...
public class ChatObject {
    ...
    public static boolean isGigagroup(TLRPC.Chat chat) {
        return (chat instanceof TLRPC.TL_channel || chat instanceof TLRPC.TL_channelForbidden) && chat.gigagroup;
    }
    ...
    public static boolean isChannelAndNotMegaGroupAndNotGigaGroup(TLRPC.Chat chat) {
        return isChannel(chat) && !isMegagroup(chat) && !isGigagroup(chat);
    }
